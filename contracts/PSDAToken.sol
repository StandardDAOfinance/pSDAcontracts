...
contract PSDAToken is ERC20, OwnableToken, ERC20MintBurn, Pausable {
  ...
  modifier onlyApprovedSeller(address from_, address to_) {
    require(balanceOf(to_) > 0 || _approvedSeller(from_) == true && requireSellerApproval_ == true, "approved seller only");
    _;
  }
  ...
  function _beforeTokenTransfer(address from_, address to_, uint256 _amount) internal override onlyApprovedSeller(from_, to_) {
