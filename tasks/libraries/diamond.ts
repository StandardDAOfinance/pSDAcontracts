...
export function getSelectors(contract: { interface: { functions: {}; getSighash: (arg0: string) => any; }; }) {
...
// get function selectors from ABI
export function getSelectorsAfterRemoveOtherFn(contract: { interface: { functions: {}; getSighash: (arg0: string) => any; }; },functionNames: any) {
  const signatures = Object.keys(contract.interface.functions)
...
// get function selectors from ABI
export function getSpecificSelector(contract: { interface: { functions: {}; getSighash: (arg0: string) => any; }; },functionNames: any) {
  const signatures = Object.keys(contract.interface.functions)
  const selectors = signatures.reduce((acc:any, val:any) => {
    if (val !== 'init(bytes)') {
      acc.push(contract.interface.getSighash(val))
